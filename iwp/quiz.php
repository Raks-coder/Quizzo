    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="col-md-4">
		 ...
		 <div class="col-md-5">
		<a href="https://sourabhbit.github.io" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Rakshit Malhotra</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 8870730077</h4>
		<h4 style="font-family:'typo' ">raks.malhotra@gmail.com</h4>
		<h4 style="font-family:'typo' ">Vellore Institute of Technology</h4></div></div>
		</p>
      </div>
